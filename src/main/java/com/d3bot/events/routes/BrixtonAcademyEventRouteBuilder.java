...
import com.d3bot.events.fetchers.BrixtonAcademyEventFetcher;
...
public class BrixtonAcademyEventRouteBuilder extends EventRouteBuilder {

    public BrixtonAcademyEventRouteBuilder(
            BrixtonAcademyEventFetcher fetcher,
